...
-- COMANDOS UTILIZADOS PARA ALTERAR A TABELA v4 E GERAR A v5

ALTER TABLE model_login ADD perfil CHARACTER VARYING(200);
UPDATE model_login SET perfil = 'ADMIN' WHERE login = 'admin';