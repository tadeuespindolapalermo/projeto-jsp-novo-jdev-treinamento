...
-- COMANDOS UTILIZADOS PARA ALTERAR A TABELA v6 E GERAR A v7

ALTER TABLE model_login ADD COLUMN foto text;
ALTER TABLE model_login ADD COLUMN extensaoFoto CHARACTER VARYING(10);